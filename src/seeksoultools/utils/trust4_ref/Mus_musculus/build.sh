...
BuildImgtAnnot.pl Mus_musculus > IMGT+C.fa
grep ">" IMGT+C.fa | cut -f2 -d'>' | cut -f1 -d'*' | sort | uniq > bcr_tcr_gene_name.txt
BuildDatabaseFa.pl refdata-gex-mm10-2020-A/fasta/genome.fa refdata-gex-mm10-2020-A/genes/genes.gtf bcr_tcr_gene_name.txt > bcrtcr.fa
